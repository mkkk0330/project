...
<form class="layui-form" >
	...
	<script id="saleChanceListBar" type="text/html">
		...
		<a class="layui-btn layui-btn-xs" id="edit" lay-event="edit">分配宿舍</a>
...
<script type="text/javascript" src="${ctx}/js/student/sale.chance.js"></script>
