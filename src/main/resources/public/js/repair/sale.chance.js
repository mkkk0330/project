layui.use(['table','layer'],function(){
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'illustrate', title: '报修说明', align:'center'},
...
// 多条件搜索
    $(".search_btn").on("click",function () {
        tableIns.reload({
            ...
            where:{
                buildingId:$("[name='customerName']").val(),// 客户名
                name:$("[name='createMan']").val(),// 创建人
                illustrate:$("[name='illustrate']").val()
    ...
    function openSaleChanceDialog(saleChanceId){
        var title = "<h3>报修名单添加操作<h3/>";
        var url = ctx + "/repair/toSaleChancePage";
