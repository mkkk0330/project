layui.use(['table','layer'],function(){
    ...
    var  tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'password', title: '用户密码', minWidth:100, align:'center'},
            {field: 'telephone', title: '用户电话', minWidth:100, align:'center'},
    ...
    function openAddOrUpdateDialog(id){
        ...
        var url = ctx + "/house/toUpdateAddPage";
